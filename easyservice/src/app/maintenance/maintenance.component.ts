...
export class MaintenanceComponent implements OnInit {
  ...
  onSearch = (maintenance: Maintenance) => {
    this.route.navigate(['/maintenance-details', maintenance.maintenanceId]);
  };
  ...
  onStatusChange = (status: any, event: any) => {
    ...
    if (event.target.checked == true) {
      this.maintenanceService
        .getMaintenancesByStatus(status.maintenanceStatus)
        .subscribe((maintenanceByStatus) => {
  ...
  onPriorityChange = (priority: any, event: any) => {
    ...
    if (event.target.checked == true) {
      this.maintenanceService
        .getMaintenancesByPriority(priority.maintenancePriority)
        .subscribe((maintenanceByPriority) => {
